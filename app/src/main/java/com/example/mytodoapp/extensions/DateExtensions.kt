 ...
 */
fun ZonedDateTime.isToday(): Boolean = LocalDate.now() == this.toLocalDate()
 ...
 */
fun ZonedDateTime.isTomorrow(): Boolean = LocalDate.now().plusDays(1) == this.toLocalDate()
 ...
 */
fun ZonedDateTime.isYesterday(): Boolean = LocalDate.now().minusDays(1) == this.toLocalDate()
 ...
 *           LocalTime instance
 */
fun LocalTime.toZonedDateTimeToday(): ZonedDateTime? = LocalDate.now()
